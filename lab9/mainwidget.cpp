...
void MainWidget::on_convertPushButton_clicked()
{
    ...
    /* MainWidget::on_convertPushButton_clicked
    * before reader and writer connections
    */
    ...
    connect(reader, &TextStreamReader::allDataReaded, writer, &QObject::deleteLater);
    connect(reader, &TextStreamReader::allDataReaded, reader, &QObject::deleteLater);
